<form id="delete_stock">
    ...
    <div class="card-header">
        <h3 class="card-title">Delete Stock</h3>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <!--end::Label-->
                <input type="text" name="product_name" class="form-control" value="{{$stock->product_id}}" readonly>
            </div>
            <!--end::col-->
        </div>
        <!--end::row-->
...
<script>
    var formId = '#delete_stock'; // Setup form id variable with # here
