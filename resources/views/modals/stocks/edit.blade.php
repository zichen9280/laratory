<form id="edit_stock">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <!--begin::Label-->
                <label class=" fw-semibold fs-6 mb-2 mt-5">Stock ID</label>
                <!--end::Label-->
            ...
            <div class="col-md-6">
                ...
                <select name="product_id" class="form-control" id="product_id">
                    <option hidden value="{{$stock->product_id}}">{{$stock->product_of->name}}</option>
    ...
    <div class="card-footer d-flex justify-content-center py-6 px-9 bg-light mt-5">
        ...
        <button type="button" class="btn btn-lg btn-secondary mx-5" id="cancel_edit" onclick="document.location.href= '{{route('stock.list')}}'">Cancel</button>

    </div>
</form>

<script>
    var formId = '#edit_stock'; // Setup form id variable with # here
