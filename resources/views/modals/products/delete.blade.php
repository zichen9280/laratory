<form id="delete_product">
    ...
    <div class="card-body">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                ...
                <!--end::Label-->
                <input type="text" name="upc" class="form-control" value="{{$product->upc}}" readonly>
            </div>
            <!--end::col-->
            <div class="col-md-6">
                <!--begin::Label-->
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                ...
                <!--end::Label-->
                <input type="text" name="remark" class="form-control" value="{{$product->remark}}" readonly>
            </div>
            <!--end::col-->
            <!--end::row-->
        </div>
    ...
    <div class="card-footer d-flex justify-content-center py-6 px-9 bg-light mt-5">
        ...
        @if($exists == true)
            <button type="submit" class="btn btn-lg btn-danger" disabled>Stock Exists</button>
        @else
            <button type="submit" class="btn btn-lg btn-danger" >Delete</button>
        @endif

            <button type="button" class="btn btn-lg btn-secondary" style="margin-left: 25px" onclick="document.location.href= '{{route('product.list')}}'">Cancel</button>
    </div>
</form>
