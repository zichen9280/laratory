...
<form id="edit_customer">
    ...
    <div class="card-footer d-flex justify-content-center py-6 px-9 bg-light mt-5">
        ...
        <button type="button" class="btn btn-lg btn-secondary" style="margin-left: 25px" onclick="document.location.href= '{{route('customer.list')}}'">Cancel</button>
    </div>
</form>

<script>
    var formId = '#edit_customer'; // Setup form id variable with # here
