            ...
            <div class="d-flex align-items-center flex-row-auto">
                ...
                <div class="d-flex align-items-center ms-1">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                        <!--begin::Heading-->
                        <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('public/assets/media/misc/menu-header-bg.jpg')">
                            <!--begin::Title-->
                ...
                <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                    ...
                    <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
                            <span class="text-white opacity-90 fs-16 fw-semibold lh-5 " id="username">Welcome back, {{ucwords(auth()->user()->name)}}</span>
                        </div>
                        <!--end::Name-->
                        <!--begin::Symbol-->
                        <div class="symbol symbol-30px symbol-md-40px">
                            <img src="assets/media/avatars/perfecto.png" alt="image" />
                        </div>
                        <!--end::Symbol-->
                    </div>
                    <!--end::User info-->
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="assets/media/avatars/perfecto.png" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-3" id="username2">{{auth()->user()->name}}</div>
                                    <a class="fw-semibold text-muted text-hover-primary fs-5" id="email_ref">{{auth()->user()->email}}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
